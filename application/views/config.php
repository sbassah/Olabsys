...
<div style="color:#000000;" id="required_fields_message"><?php echo $this->lang->line('common_fields_required_message'); ?></div>
<ul id="error_message_box"></ul>
<legend style="color:#000000;"><?php echo $this->lang->line("config_info"); ?></legend>
...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('common_receipt_code').':', 'receipt_code',array('class'=>'wide required')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'receipt_code',
		'id'=>'receipt_code',
		'size'=>'60',
		'value'=>$this->config->item('receipt_code')));?>
	</div>
</div>
