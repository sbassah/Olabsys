...
<div id="edit_sale_wrapper">
	<h1><?php echo $this->lang->line('sales_edit_sale') . ' ' ;  echo $this->config->item('receipt_code') .' '. $sale_info['sale_id']; ?></h1>
	...
	<?php echo form_label($this->lang->line('sales_receipt').':', 'customer'); ?>
		<div class='form_field'>
			<?php echo anchor('sales/receipt/'.$sale_info['sale_id'], $sale_info['receipt_id'], array('target' => '_blank'));?>
		</div>
	</div>
